  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 p-5 md:p-10 md:w-[60vw] border-zinc-800" 
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-1">
                        <span className="text-xl font-bold leading-[1.6] text-gray-400">
                          {item.name}
                        </span>
                        <span className="text-sm leading-[1.6] font-normal 0 text-gray-400">
                          {item.title}
                        </span>
                    </div>
                </span>
